# Generated by Assemblage v92e2b7.
...
help: 
	...
	@echo ' - [04mHAS_DUMPAST=$(HAS_DUMPAST)[m -- dump the AST (build optimisation phase)'
...
$(BUILDIR)/bin-ocaml-dumpast/parse_compat.cml-byte: $(BUILDIR)/bin-ocaml-dumpast/parse_compat.ml
	@if test -n "$$VERBOSE"; then echo '$(DUMPAST) camlp4o $(bin-ocaml-dumpast-parse_compat.pp-byte) $(BUILDIR)/bin-ocaml-dumpast/parse_compat.ml > $(BUILDIR)/bin-ocaml-dumpast/parse_compat.cml-byte'; else echo '[33mbin-ocaml-dumpast-parse_compat[m        [01mpp-byte[m                parse_compat.cml-byte'; fi
	@$(DUMPAST) camlp4o $(bin-ocaml-dumpast-parse_compat.pp-byte) $(BUILDIR)/bin-ocaml-dumpast/parse_compat.ml > $(BUILDIR)/bin-ocaml-dumpast/parse_compat.cml-byte

$(BUILDIR)/bin-ocaml-dumpast/parse_compat.cml-native: $(BUILDIR)/bin-ocaml-dumpast/parse_compat.ml
	@if test -n "$$VERBOSE"; then echo '$(DUMPAST) camlp4o $(bin-ocaml-dumpast-parse_compat.pp-native) $(BUILDIR)/bin-ocaml-dumpast/parse_compat.ml > $(BUILDIR)/bin-ocaml-dumpast/parse_compat.cml-native'; else echo '[33mbin-ocaml-dumpast-parse_compat[m        [01mpp-native[m              parse_compat.cml-native'; fi
	@$(DUMPAST) camlp4o $(bin-ocaml-dumpast-parse_compat.pp-native) $(BUILDIR)/bin-ocaml-dumpast/parse_compat.ml > $(BUILDIR)/bin-ocaml-dumpast/parse_compat.cml-native
...
$(BUILDIR)/bin-ocaml-dumpast/dumpast.cml-byte: $(BUILDIR)/bin-ocaml-dumpast/dumpast.ml
	@if test -n "$$VERBOSE"; then echo '$(DUMPAST) camlp4o $(bin-ocaml-dumpast-dumpast.pp-byte) $(BUILDIR)/bin-ocaml-dumpast/dumpast.ml > $(BUILDIR)/bin-ocaml-dumpast/dumpast.cml-byte'; else echo '[33mbin-ocaml-dumpast-dumpast[m             [01mpp-byte[m                dumpast.cml-byte'; fi
	@$(DUMPAST) camlp4o $(bin-ocaml-dumpast-dumpast.pp-byte) $(BUILDIR)/bin-ocaml-dumpast/dumpast.ml > $(BUILDIR)/bin-ocaml-dumpast/dumpast.cml-byte

$(BUILDIR)/bin-ocaml-dumpast/dumpast.cml-native: $(BUILDIR)/bin-ocaml-dumpast/dumpast.ml
	@if test -n "$$VERBOSE"; then echo '$(DUMPAST) camlp4o $(bin-ocaml-dumpast-dumpast.pp-native) $(BUILDIR)/bin-ocaml-dumpast/dumpast.ml > $(BUILDIR)/bin-ocaml-dumpast/dumpast.cml-native'; else echo '[33mbin-ocaml-dumpast-dumpast[m             [01mpp-native[m              dumpast.cml-native'; fi
	@$(DUMPAST) camlp4o $(bin-ocaml-dumpast-dumpast.pp-native) $(BUILDIR)/bin-ocaml-dumpast/dumpast.ml > $(BUILDIR)/bin-ocaml-dumpast/dumpast.cml-native
